...
public class grid_connection : ScriptableObject
{
    ...
    [SerializeField] List<ScriptableObject> Next_Station = new List<ScriptableObject>();
    ...
    public List<ScriptableObject> next_station { get { return Next_Station; } set { Next_Station = value; } }
